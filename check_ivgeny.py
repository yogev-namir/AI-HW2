...
class PirateStochasticProblem:
    ...
    def terminate_execution(self):
        """
        terminate the execution of the problem after 500 iterations
        """
        increase_score(self.score)
        raise EndOfGame
    ...
    for an_input in small_inputs:
        ...
        for i in range(TIMES_TO_RUN):
            try:
                ...
                my_problem.state = deepcopy(my_problem.initial_state)
                my_problem.score = 0
                continue
        print(f'Average score is: {score/TIMES_TO_RUN}\n')
    for an_input in additional_inputs:
        ...
        for i in range(TIMES_TO_RUN):
            try:
                ...
                my_problem.score = 0
                continue
        print(f'score is: {score / TIMES_TO_RUN}')
